...
class TestGdriveSync(TestCase):
    ...
    def test_init(self):
        self.assertEqual({}, self.gdriveSync._remote_file_id_dict)
    ...
    def test_process_dir_pairs(self, mock_get_remote_dir, mock_get_remote_files_from_dir, mock_list_files_under_local_dir,
                               mock_get_inode_no):
        mocked_service = Mock()
        dir_pairs = {'/home/test1/child': '/test1/child'}
        mock_get_remote_dir.return_value = 'remote_dir_id'
        ...
        self.gdriveSync._compare_and_sync_files.assert_called_once_with(mocked_service, 
                                                                        ...
                                                                        '/home/test1/child')
        self.assertEqual({101:'remote_dir_id'},
                         self.gdriveSync._remote_file_id_dict)
        mock_get_inode_no.assert_called_once_with('/home/test1/child')
    ...
    def test_compare_and_sync_files(self, mock_convert_rfc3339_time_to_epoch, mock_copy_remote_file_to_local, 
                                    mock_overwrite_remote_file_with_local, mock_copy_local_file_to_remote):
        mocked_service = Mock()
        remote_files = [{'id': '1', 'name': 'file1', 'modifiedTime': 'modifiedTime1'},
                        {'id': '2', 'name': 'file2', 'modifiedTime': 'modifiedTime2'},
                        {'id': '3', 'name': 'file3', 'modifiedTime': 'modifiedTime3'}]
        ...
        local_files = [local_file_mock_1, local_file_mock_2, local_file_mock_4]
        mock_convert_rfc3339_time_to_epoch.return_value = 100
        mock_copy_remote_file_to_local.side_effect = [0, 1003]
    ...
    def test_watch_local_dir(self, mock_LocalFSEventHandler, mock_observer):
        ...
        mock_LocalFSEventHandler.assert_called_once_with(self.gdriveSync._remote_file_id_dict)
